...
function positionContent() {
	window.winWidth = $(window).width(), $fullHeight.height(window.innerHeight ? window.innerHeight : $(window).height()), $(window).width() > 992 ? $("#wrapper nav #menu").height($(window).height()) : $("#wrapper nav #menu").css("height", ""), $valign.each(function () {
		$(this).css("padding-top", $(this).parent().height() / 2 - $(this).height() / 2)
	});
	var e = $(window).width(), t = $("#block-1").height();
...
var $wrapper = $("#wrapper"), $header = $("header"), $section = $("section"), $footer = $("footer"),
	$valign = $(".valign"), $fullHeight = $(".full-height"), $imgFit = $(".img-fit"), $blockSlider = $("#block-1"),
	$toLoad = $(".to-load");
window.winWidth = $(window).width();
var animRunning = !1, currentScroll = -1, InfiniteSliderFade, vivusArray = [], doAnim = 0, mouseTO;
