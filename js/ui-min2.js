...
function positionContent() {
	...
	$fullHeight.height(window.innerHeight ? window.innerHeight : $(window).height());
	$(window).width() > 992 ? $("#wrapper nav #menu").height($(window).height()) : $("#wrapper nav #menu").css("height", "");
	...
	var e = $(window).width();
	var t = $("#block-1").height();

	$("#block-1 .slider ul li .img-slider").css("min-width", e);
	$("#block-1 .slider ul li").css("height", t);
	$(".slider-wrapper").each(function () {
		...
		$object.height(t);
		$("li.active", $object).css("width", e);
		$("ul.slider", $object).css("width", e);
		$("li.active", $object).css("height", t);
		$("ul.slider", $object).css("height", t);
	});
	var i = $(".full-menu.active").outerHeight();
	$("#block-2").height(i);
	var o = $(".map img").height();
	$("#map").css("height", o), $imgFit.each(function () {
		var e = $(this), t = $(this).parent(), i = t.width(), o = t.height(), a = $(this).attr("data-size").split("|"),
			n = a[0] / a[1], s = i / o;
...
function scrollContent() {
	...
	window.winWidth > 992 ? ($(".to-load").each(function () {
		var e = $(this);
		...
		$object = $(this);
		var e = 1, t = newScroll + $(window).height() - $object.offset().top;
		t < 0 && (t = 0);
		var i = $(window).height() / 2, o = 0, a = 0;
		o = t < i ? (i - t) / i : -(t - i) / i;
		var a = 75 * o;
		...
		$object = $(this);
		var e = 2, t = newScroll + $(window).height() - $object.parent().offset().top;
		t < 0 && (t = 0);
		var i = $(window).height(), o = 0, a = 0;
		o = t < i ? -(i - t) / i : (t - i) / i;
		var a = 200 * o;
		$object.css("transform", "translate3d(0," + Math.round(a) + "px, 0)");
		var n = 200, s = $("#block-1"), l = .5 * newScroll, r = 1 - (newScroll - 200) / (1 * s.height());
		if (r <= 0) var r = 0; else var r = 1 - (newScroll - 200) / (1 * s.height());
		...
		$object = $(this);
		var e = 2, t = newScroll + $(window).height() - $(".pattern").offset().top;
		t < 0 && (t = 0);
		var i = $(window).height() / 2, o = 0, a = 0;
		o = t < i ? -(i - t) / i : (t - i) / i;
		var a = 150 * o;
		...
		if ($object = $(this), objectParent = $(this).parent(), window.winWidth > 1440) var e = 1.5; else var e = 1;
		var t = newScroll + $(window).height() - $("#block-4").offset().top;
		t < 0 && (t = 0);
		var i = $(window).height() / 2, o = .55 * $(window).height(), a = 0, n = 0;
		a = t < o ? -(o - t) / o : (t - o) / o;
		var n = 125 * e * a;
		n > 100 && breakBone(), $object.css("transform", "translate3d(0, " + Math.round(n) + "px, 0)")
	}), $(".floating-things-down-burger").each(function () {
		if ($object = $(this), objectParent = $(this).parent(), window.winWidth > 1440) var e = 2.3; else var e = 1.8;
		var t = newScroll + $(window).height() - $("#block-6").offset().top;
		t < 0 && (t = 0);
		var i = $(window).height() / 2, o = .6 * $(window).height(), a = 0, n = 0;
		a = t < o ? -(o - t) / o : (t - o) / o;
		var n = 125 * e * a;
		$object.css("transform", "translate3d(0, " + Math.round(n) + "px, 0)")
	}), $(".burger-closing ul li").each(function () {
		if ($object = $(this), window.winWidth > 1440) var e = .75; else var e = .75;
		var t = newScroll + $(window).height() - $(".burger-closing").offset().top;
		t < 0 && (t = 0);
		var i = .45 * $(window).height(), o = 0, a = 0;
		o = t < i ? (i - t) / i : -(t - i) / i;
		var a = 125 * e * o;
		if (window.winWidth > 1699) if (a > -78) {
			var a = 125 * e * o;
			$("#block-6 .burger-closing p").removeClass("animated")
		} else a = -78, $("#block-6 .burger-closing p").addClass("animated"); else if (a > -60) {
			var a = 125 * e * o;
			$("#block-6 .burger-closing p").removeClass("animated")
		...
		$object = $(this);
		var e = 1.5, t = newScroll + $(window).height() - $object.offset().top;
		t < 0 && (t = 0);
		var i = $(window).height() / 2, o = 0, a = 0;
		o = t < i ? -(i - t) / i : (t - i) / i;
		var a = 75 * o;
...
var $imgFit = $(".img-fit");
var $blockSlider = $("#block-1");
var $toLoad = $(".to-load");

window.winWidth = $(window).width();
var animRunning = !1;
var currentScroll = -1;
var InfiniteSliderFade;
var vivusArray = [];
var doAnim = 0;
var mouseTO;
...
$(window).load(function () {
	function e() {
		var e = $("#map"), o = e.data("lat"), a = e.data("lng"), n = e.data("mappin"), s = new google.maps.LatLng(o, a);
		t = new google.maps.Map(document.getElementById("map"), {
			...
			new google.maps.Marker({position: s, title: "Vallier Bistro", icon: n}).setMap(t)
	}
...
$(document).ready(function () {
	positionContent(), $("svg").each(function () {
		...
		var e = $(this), t = e.find("ul.slider"), i = e.width(), o = $("li.active img", e).height();
		if (e.height(o), !t.hasClass("animating")) {
			t.addClass("animating");
			var a = $("> li", t).length - 1, n = $("> li.active", t).index();
			...
			$(".icon-under").each(function () {
				var e = $("li", $(this)).length - 1, t = $("li.active", $(this)).index(), i = t + 1;
		...
		var e = $(this).attr("data-menu"), t = $(".full-menu[data-menu='" + e + "']"), i = $(".full-menu");
		$("#block-2 #sub-nav ul li").removeClass("active"), $(this).addClass("active");
		var o = t.outerHeight();
		return setTimeout(function () {
			$("#block-2").height(o)
		}, 2e3), $("html, body").animate({scrollTop: $("#block-2").offset().top}, 1200, "easeInOutQuart"), setTimeout(function () {
		...
		return setTimeout(function () {
			$("#block-2").height(o)
		}, 2250), $("html, body").animate({scrollTop: $("#block-2").offset().top - 105}, 1200, "easeInOutQuart"), setTimeout(function () {
			i.removeClass("active"), setTimeout(function () {
				i.hide(), t.show()
			}, 1e3)
		}, 250), setTimeout(function () {
		...
		return $("nav").removeClass("opened"), $("#burger").removeClass("opened"), window.winWidth < 982 ? $("html, body").animate({scrollTop: $($(this).attr("href")).offset().top - 55}, 1500, "easeInOutQuart") : $("html, body").animate({scrollTop: $($(this).attr("href")).offset().top}, 1500, "easeInOutQuart"), !1
	})
});